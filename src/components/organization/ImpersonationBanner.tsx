...
export function ImpersonationBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[90] flex items-center justify-center gap-3 bg-amber-500 px-4 py-1.5 text-sm font-medium text-amber-950 shadow-sm">
      ...
      <button
        ...
        className="ml-2 inline-flex items-center gap-1 rounded-md bg-amber-600/30 px-2 py-0.5 text-xs font-semibold hover:bg-amber-600/50 transition-colors"
      >
        <X className="h-3 w-3" />
