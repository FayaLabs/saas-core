...
const STATUS_OPTIONS: { value: InvoiceStatus; label: string; color: string }[] = [
  { value: 'open', label: 'Open', color: 'bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400' },
  { value: 'partial', label: 'Partial', color: 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400' },
  { value: 'paid', label: 'Paid', color: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400' },
  { value: 'overdue', label: 'Overdue', color: 'bg-red-100 text-red-700 dark:bg-red-500/20 dark:text-red-400' },
